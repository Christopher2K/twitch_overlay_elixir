...
username =
  if is_auto?, do: System.get_env("ADMIN_USERNAME"), else: IO.gets("Username: ") |> String.trim()

password =
  if is_auto?, do: System.get_env("ADMIN_PASSWORD"), else: IO.gets("Password: ") |> String.trim()
